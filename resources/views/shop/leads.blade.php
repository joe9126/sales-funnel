  ...
  <!--  <div class="col-md-1 leftstrip"></div>-->
        <div class="  formcontainer">
            <div class="row pageheading">
                <div class="col-md-4"><h1 class="pagetitle">Sales Leads</h1></div>
                <div class="col-md-8">
                    <div class="tab-controller">
                        <button class="btn btn-primary taskitem" id="current_opportunities"  onclick="openTask(event,'currentopportunitytask')">Current Leads</button>
                        <button class="btn btn-primary taskitem" id="new_opportunities" onclick="openTask(event,'newopportunitytask')">New Lead</button>
                        <button class="btn btn-primary taskitem" id="update_opportunities" onclick="openTask(event,'updateopportunitytask')">Update Lead</button>
                        <button class="btn btn-primary  taskitem" id="closed_opportunities" onclick="openTask(event,'closedopportunitytask')">Closed Leads</button>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 taskpanel">
                    <div class="row">
                        <div class="col-md-4">
                            <h3 class="tasktitle">Current Leads</h3> <!-- Default Task title, do not change -->
                        </div>
                        <div class="col-md-8">
                    ...
                    <!-- New Leads Tab -->
                    <div class="task mb-5" id="newopportunitytask">
                        <form action="" id="newopportunityform" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-label-group">
                                        <input type="text" name="opportune_title" id="opportune_title" class="form-control taskinput" placeholder="" required  data-parsley-trigger="keyup" data-parsley-required-message="Lead title is required!"/>
                                        <label for="opportune_title">Lead Title</label>
                                    </div>

                                    <div class="form-label-group">
                                        <textarea id="opportune_descrip" rows="3" class="form-control" name="opportune_descrip" required placeholder="a brief description of lead" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="1000" data-parsley-minlength-message="Come on! You need to enter at least a 20 character description..." data-parsley-validation-threshold="10" data-parsley-required-message="Brief description is required!" ></textarea>
                            ...
                            <div class="form-label-group">
                                <input class="btn btn-lg btn-primary btn-block btn-login text-uppercase font-weight-bold" type="submit" id="submit" value="Create"/>
                            </div>
...
<div class="opportunity-trail" id="opportunity-trail" style="display: none; overflow-y: hidden;" >
    ...
    <div class="row">
        <div class="col-md-1"></div>
        <div class="col-md-5">  <label>Lead #: </label> <span id="opportunityid"></span></div>
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                   <textarea name="trailupdate" id="trailupdate" placeholder="Status Update" style="display: inline-block; width:380px;"class="form-control" rows="3" required data-parsley-trigger="keyup" data-parsley-required-message="Status event is required!" data-parsley-minlength="20">
                        </textarea>
                </div>
            </div>
            <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <input type="submit" id="addtrailbtn" class="btn btn-success" value="Add Trail"/>
                <input type="button" name="closeopportunitybtn" id="closeopportunitybtn" class="btn btn-danger" value="Mark Closed" onclick="closeOpportunity()"/>
                <input type="button" id="viewhistory" class="btn btn-info" value="View Trails" onclick="viewTrails()"/>
                <!--<button class="btn btn-primary" id="closeopport" name="closeopport" onclick="markClosed()">Test</button>-->
            </div>
            <div class="col-md-2"></div>
        </div>
    </form>
       ...
       <!-- <div class="col-md-10"></div> -->
        <div class="trailstablediv">
            <table id="trailstable" class="table table-striped">
                ...
                <tr>
                    <th>No</th><th>Status Event</th><th>Event Date</th><th>Updated By</th>
                </tr>
                </thead>
                <tbody></tbody>
                <tfoot></tfoot>
